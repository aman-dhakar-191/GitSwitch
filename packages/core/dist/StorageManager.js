...
class StorageManager {
     ...
     */
    recordProjectActivity(projectId, activity) {
     ...
     */
    recordAccountSwitch(projectId, accountId) {
     ...
     */
    recordErrorPrevented(projectId) {
        const analytics = this.getAnalytics();
     ...
     */
    recordPatternAccuracy(patternId, wasAccurate) {
        const patterns = this.getPatterns();
