...
class GitHookManager {
    constructor(gitManager, storageManager, smartDetector) {
     ...
     */
    installHooks(projectPath, config) {
        try {
     ...
     */
    autoFixIdentity(projectPath, accountId) {
        try {
            const accounts = this.storageManager.getAccounts();
    ...
    installPreCommitHook(hooksDir, config) {
        const preCommitPath = path.join(hooksDir, 'pre-commit');
...
`;
    ...
    saveHookConfig(projectPath, config) {
        const hookConfig = {
            projectPath,
            hooksInstalled: true,
...
exports.default = GitHookManager;
